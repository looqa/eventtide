const t={priority:1},e={exact:!1},s={debug:!1,suppress:!0,async:!1};
/**
 * @type {EventConfig}
...
/**
 * @type Event
 */}class a{constructor(path,payload=null,t={}){this.config=n(t,e),this.path=new r(path,!0),this.payload=payload}isExact=()=>this.config.exact}const c={},p=(busId="default",busConfig={})=>{c[busId]?Object.keys(busConfig).length&&console.warn(`Bus ${busId} was already defined, but there is another call with config. This config was not applied`)
/**
     * @type Bus
