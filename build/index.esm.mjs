...
/**
 * @type Event
 */}class a{constructor(t,s=null,i={}){this.config=n(i,e),this.path=new r(t,!0),this.payload=s}isExact=()=>this.config.exact}const c={},p=(t="default",e={})=>{c[t]?Object.keys(e).length&&console.warn(`Bus ${t} was already defined, but there is another call with config. This config was not applied`)
/**
     * @type Bus
