"use strict";const defaultListenerConfig={priority:1};
/**
 * @type {EventConfig}
...
/**
     ...
     */const emit=(path,payload=null,eventConfig={})=>{const event=new Event(path,payload,eventConfig);return busInstance.call(event)};return{on:on,emit:emit}};exports.bus=bus;
